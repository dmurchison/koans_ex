...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    fido = Dog2.new
    assert_equal [], fido.instance_variables    # This becuase set_name was not called (or is not an initialize method)
  ...
  def test_args_to_new_must_match_initialize
    ...
    # THINK ABOUT IT:
    # Why is this so?
    # I believe that this is the purpose of our initialize methods.
  end
