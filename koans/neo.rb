...
# rubocop:disable Layout/ExtraSpacing, Layout/SpaceInsideStringInterpolation
# !/usr/bin/env ruby
# -*- ruby -*-
...
module Neo
  ...
  module Assertions
    ...
    def assert_nothing_raised
      ...
      flunk "Expected nothing to be raised, but exception #{e.inspect} was raised"
    end
  end
  ...
  # Class to hold the state of a running path
  class Koan
    include Assertions
  ...
  # The Class to hold the state of a running path
  class ThePath
    def walk
...
# rubocop:enable Layout/ExtraSpacing, Layout/SpaceInsideStringInterpolation
