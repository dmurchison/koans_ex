...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    assert_equal 9, result    # Becuase 0 + 2 + 3 + 4 = 9

    result2 = [2, 3, 4].inject(1) { |product, item| product * item }
    assert_equal 24, result2    # Becuase 6 * 4 = 24

    # Extra Credit:
    # Describe in your own words what inject does.

    # ANSWER:
    # I originally just thought of it as an enumerator with an extra variable for your own use.
    # But now I think of it as a way to manipulate a collection of data into one single value.
  end
  ...
  # ANSWER: 
  # The first way is a block, which is allowed us to use the file object
  # without having to worry about closing it. The second way is a method call.
