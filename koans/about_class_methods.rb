...
class AboutClassMethods < Neo::Koan
  ...
  # ANSWER:
  # I prefer to use `self.class_method` if I'm writing instance methods within the class.
  # However, I'd use `class << self` if the class will only be consisting of class methods.
